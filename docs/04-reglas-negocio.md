...
- **Asignación atómica**: Al procesarse el pago de la orden con éxito, el sistema debe de manera transaccional:
  ...
  3. Marcar las claves como vendidas (`SOLD`) y recalcular la disponibilidad del producto a partir del conteo de claves restantes.
...
## 3. Reglas de Aprobación de Órdenes
