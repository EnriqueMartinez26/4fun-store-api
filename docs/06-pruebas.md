...
- **Asignación Atómica**: Comprueba que al marcar una orden como pagada, se busquen las keys correspondientes, se asocien a la orden, se marquen como usadas (`SOLD`) y actualicen el stock disponible del producto.
