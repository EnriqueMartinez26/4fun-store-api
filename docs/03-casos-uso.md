...
- **Crear orden de compra (checkout)**: Generar una orden en estado `PENDING`, consolidando los precios actuales de los videojuegos y verificando la disponibilidad de las claves requeridas.
...
- **Administrar stock digital**: Cargar claves digitales para productos específicos y revisar la disponibilidad de sus publicaciones.
